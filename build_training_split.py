...
def generate_training_split(num_batches, path=None):
    ...
    shutil.copytree(path + 'training_testing_split/set1/GRASP/new_pp5_labeled/test_set/', path + 'training_testing_split/set1/GRASP/new_pp5_labeled/training_set/')
    ...
    for set_num in batch_nums:
        ...
        for file in pick_fail_batches[set_num-1]:
            shutil.copyfile(path+ 'PICK/new_pp5_labeled/test_set/failed/'+file,path+'training_testing_split/set'+str(set_num)+'/PICK/new_pp5_labeled/test_set/failed/'+file)
            for o_set in other_sets:
                shutil.copyfile(path+ 'PICK/new_pp5_labeled/test_set/failed/'+file,path+'training_testing_split/set'+str(o_set)+'/PICK/new_pp5_labeled/training_set/failed/'+file)
        for file in grasp_fail_batches[set_num-1]:
            shutil.copyfile(path+ 'GRASP/new_pp5_labeled/test_set/failed/'+file,path+'training_testing_split/set'+str(set_num)+'/GRASP/new_pp5_labeled/test_set/failed/'+file)
            for o_set in other_sets:
                shutil.copyfile(path+ 'GRASP/new_pp5_labeled/test_set/failed/'+file,path+'training_testing_split/set'+str(o_set)+'/GRASP/new_pp5_labeled/training_set/failed/'+file)
        for file in pick_success_batches[set_num-1]:
            try:
                shutil.copyfile(path+ 'PICK/new_pp5_labeled/test_set/successful/'+file,path+'training_testing_split/set'+str(set_num)+'/PICK/new_pp5_labeled/test_set/successful/'+file)
                for o_set in other_sets:
                    shutil.copyfile(path+ 'PICK/new_pp5_labeled/test_set/successful/'+file,path+'training_testing_split/set'+str(o_set)+'/PICK/new_pp5_labeled/training_set/successful/'+file)
            except:
                shutil.copyfile(path+ 'PICK/new_pp5_labeled/test_set/could_be_success/'+file,path+'training_testing_split/set'+str(set_num)+'/PICK/new_pp5_labeled/test_set/successful/'+file)
                for o_set in other_sets:
                    shutil.copyfile(path+ 'PICK/new_pp5_labeled/test_set/could_be_success/'+file,path+'training_testing_split/set'+str(o_set)+'/PICK/new_pp5_labeled/training_set/successful/'+file)

        for file in grasp_success_batches[set_num-1]:
            try:
                shutil.copyfile(path+ 'GRASP/new_pp5_labeled/test_set/successful/'+file,path+'training_testing_split/set'+str(set_num)+'/GRASP/new_pp5_labeled/test_set/successful/'+file)
                for o_set in other_sets:
                    shutil.copyfile(path+ 'GRASP/new_pp5_labeled/test_set/successful/'+file,path+'training_testing_split/set'+str(o_set)+'/GRASP/new_pp5_labeled/training_set/successful/'+file)
            except:
                shutil.copyfile(path+ 'GRASP/new_pp5_labeled/test_set/could_be_success/'+file,path+'training_testing_split/set'+str(set_num)+'/GRASP/new_pp5_labeled/test_set/successful/'+file)
                for o_set in other_sets:
                    shutil.copyfile(path+ 'GRASP/new_pp5_labeled/test_set/could_be_success/'+file,path+'training_testing_split/set'+str(o_set)+'/GRASP/new_pp5_labeled/training_set/successful/'+file)
